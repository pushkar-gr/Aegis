...
The Aegis Agent is a Rust based daemon designed to run on routers. It uses `libbpf-rs` to load XDP program to the kernel, enforcing a strictly "default-drop" network policy with minimal overhead.
